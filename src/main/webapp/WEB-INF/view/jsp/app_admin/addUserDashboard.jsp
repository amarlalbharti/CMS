				...
				<div class="box box-info">
					<div class="box-header with-border">
						...
						<div class="pull-right " style="padding-left: 20px;">
				           <a href="appNewUser" class="btn btn-primary xs btn-xs">Add User</a>
			            </div>
									...
									for(Registration reg : regList)
									{
										%>
											<tr>
												...
												<td><%= reg.getName() %> </td>
												<td><%= reg.getUserId() %> </td>
												<td><%= DateFormats.ddMMMyyyy().format(reg.getRegdate()) %> </td>
												<td><%= roles.get(reg.getUserId()).getUserrole() %> </td>
												<%-- <td><%= reg.getContactNumber() %> </td> --%>
												
												<td class="text-center"> 
												  <a class="btn btn-primary btn-xs" href="appAddDept?userId=<%= reg.getUserId() %>" ><i class="fa fa-fw fa-edit"></i> Add Department</a>
												  <a class="btn btn-primary btn-xs" href="appEditUser?userId=<%= reg.getUserId() %>" ><i class="fa fa-fw fa-edit"></i> Edit</a>
												  <a class="btn btn-primary btn-xs" href="appViewUser?userId=<%= reg.getUserId() %>" ><i class="fa fa-fw fa-edit"></i> View</a>
												</td>
											</tr>
										<%
									}
