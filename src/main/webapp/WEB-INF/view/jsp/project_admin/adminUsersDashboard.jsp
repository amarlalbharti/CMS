				...
				<div class="box box-info">
					<div class="box-header with-border">
						...
						<div class="pull-right " style="padding-left: 20px;">
				           <a href="adminNewUser" class="btn btn-primary xs btn-xs">Add User</a>
			            </div>
										...
										%>
											<tr>
												...
												<td class="text-center"> 
												  <a class="btn btn-primary btn-xs" href="adminEditUser?userId=<%= reg.getUserId() %>" ><i class="fa fa-fw fa-edit"></i> Edit</a>
												  <a class="btn btn-primary btn-xs" href="adminViewUser?userId=<%= reg.getUserId() %>" ><i class="fa fa-fw fa-edit"></i> View</a>
												</td>
											</tr>
										<%
									}
