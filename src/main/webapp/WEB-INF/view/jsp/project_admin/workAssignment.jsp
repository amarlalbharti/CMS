...
<input type="hidden" id=mode name="mode" value="${mode}">
	<div class="content-wrapper">
      ...
      <h1 class="page-header"> Complain Assignment </h1>
      Assign Particular Complain to Particular Member.
      <ol class="breadcrumb">
			...
			<div class="box box-info">
				...
				%> --%>
					<div class="box-header with-border">
						<h3 class="box-title">Assign Complain To Particular Member(s)</h3>
					</div>
			      ...
			      --%>         <div class="box-body">
				                ...
				                <div class="form-group col-xs-12 col-md-6">
				                  <label>Assign Work</label><span class="text-danger">*</span>
				                  <select id="assignWork" class="form-control"  tabindex="1">
