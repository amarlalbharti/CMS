...
<input type="hidden" id=mode name="mode" value="${mode}">
	<div class="content-wrapper">
      ...
      <h1 class="page-header"> New Complain List </h1>
      <ol class="breadcrumb">
			...
			<div class="col-xs-12 col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">List of New Complain</h3>
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td class="text-center"> 
								  <a class="btn btn-primary btn-xs" href="adminSetPriority"><i class="fa fa-fw fa-edit"></i> Set Priority</a>
								  <a class="btn btn-primary btn-xs" href="adminWorkAssignment"><i class="fa fa-fw fa-edit"></i> Assign work</a>
